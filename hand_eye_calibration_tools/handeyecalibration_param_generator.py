...
gripper_pose = []
save_dir = "hand_eye_calibration_2"
calib_data = "calib_data_logitech_c270.npz"
count = 1
...
# 🔹 캘리브레이션 파일도 같은 위치 기준
calib_path = os.path.join(BASE_DIR, calib_data)
...
while True:
    ...
    if key == 27:  # ESC to exit
        np.savez(os.path.join(save_dir, f"{os.path.basename(save_dir)}.npz"),
